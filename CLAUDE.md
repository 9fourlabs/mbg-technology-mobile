...
- **Play Console listing** — to actually `eas submit --platform android`, Tim needs to register `com.9fourlabs.mbg.app` in Play Console, complete the listing (icon, screenshots, privacy URL, content rating).
