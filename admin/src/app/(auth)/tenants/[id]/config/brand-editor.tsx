...
export default function BrandEditor({ tenantId, config, onChange }: BrandEditorProps) {
  ...
  return (
    <div>
      <h2 className="text-base font-semibold text-white mb-1">Brand Settings</h2>
          ...
          <div key={field.key}>
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                placeholder="#000000"
                className="w-28 px-3 py-2 rounded-lg bg-gray-800 border border-gray-700 text-sm text-white font-mono focus:outline-none focus:ring-2 focus:ring-[#2563EB]"
              />
              <div
